...
class cbfs(param.Parameterized):
    ...
    def __init__(self,  **params):
        ...
        self.panels = []
        self.loaded_file = "The_Hidden_Wonders_of_Deep Ocean_Life.pdf"
...
### OUTPUT:
#### Conversation 
<img width="991" height="682" alt="image" src="https://github.com/user-attachments/assets/abcdb337-d954-4fa0-a8ae-bff8b4d59f37" />

#### Database
<img width="998" height="670" alt="image" src="https://github.com/user-attachments/assets/cefb7579-1202-486f-aa18-5fd312b4985d" />
